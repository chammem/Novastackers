      ...
      <div className="col">
        <div className="site-logo-wrap">
          <div className="site-logo">
            <Link to="/"><img src="broccoli/img/logo.png" alt="Logo" /></Link>
          </div>
        </div>
      </div>
              ...
              <ul>
                ...
                <li><a href="#">Shop</a>
                  <ul>
                    ...
                    <li><a href="">Shop details no sidebar </a></li>
                ...
                <li ><a href="#">Pages</a>
                  <ul className="mega-menu">
                    ...
                    <li><a href=""><img src="broccoli/img/banner/menu-banner-1.png" alt="#" /></a>
                    </li>
                  </ul>
                </li>
                <li><a href="">Contact</a></li>
                <li className="special-link"><Link to="/role">Join Us Now</Link></li>
              </ul>
            </div>
          </nav>
        </div>
          ...
          <ul>
            <li>
              ...
              <ul>
                ...
                <li> <Link to="/role">Register</Link></li>
