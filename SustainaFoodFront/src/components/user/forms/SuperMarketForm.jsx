...
function SuperMarketForm() {
        ...
        const RegisterUser = () => {
            console.log(supermarketName,phoneNumber,email,password,adress,confirmPassword,buisnessLicense,buisnessType);
        }
  return (
    ...
    <div className="row">
      <div className="col-lg-12">
        <div className="section-title-area text-center">
          <h1 className="section-title">Register <br />As SuperMarket</h1>
    ...
    <div className="row">
      <div className="col-lg-6 offset-lg-3">
        <div className="account-login-inner">
          ...
          <input  onChange={(e)=> setSupermaketName(e.target.value)}  type="text" name="firstname" placeholder="Super Market Name" />
              ...
              <input  onChange={(e)=> setBuisnessType(e.target.value)} type="password" name="confirmpassword" placeholder="buisnes Type"/>
